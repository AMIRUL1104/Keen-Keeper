...
// export default function StatsPage({ isAnimationActive = true }) {
//   // ১. ডেটা রাখার জন্য একটি স্টেট তৈরি করুন
//   const [data, setData] = useState([]);
//   // const [mounted, setMounted] = useState(false);

//   // ২. useEffect ব্যবহার করে ব্রাউজারে ডেটা লোড করুন
//   useEffect(() => {
//     const storedData = localStorage.getItem("timelineData");
//     if (storedData) {
//       setData(JSON.parse(storedData));
//     }
//     // setMounted(true); // মাউন্ট হয়েছে কিনা তা নিশ্চিত করতে
//   }, []);

//   // Hydration mismatch এড়াতে এটি প্রয়োজন
...
//         </h1>
//         <p className="text-gray-500 text-sm">
//           No data available. Please check in with your friends to see stats
//           here.
//         </p>
//       </div>
//     );
